...
% plot fig.2 A B D E
colormap1=[107 49 9; 166 76 14;223 102 19;241 148 85; 248 199 166; 207 205 205];colormap1=colormap1./255;% fig.2 A B
colormap2=[20 49 76;41 107 167;64 139 208;105 164 217; 191 216 239; 207 205 205];colormap2=colormap2./255;% fig.2 D E
cncode=[33 22 52 61 21];% 33 Namibia; 22 Israel; 52 Hubei; 61 California; 21 Iran;
for k=1:4
    ...
    if k<=2
        ...
        for cn=1:78
            if ismember(cn,cncode)==0
                ...
                plot(t2,'LineStyle','-','LineWidth',0.2,'Color',colormap1(6,1:3)); hold on;
            end
        end
        % Namibia; Israel; Hubei; California; Iran;
        for cn=1:5
    ...
    % CCM analysis of ΔNO2* and A;
        ...
        for cn=1:78
            if ismember(cn,cncode)==0
                t2=t1(cn,:);idx=find(t2~=0 & ~isnan(t2));t2=t2(idx);
                plot(t2,'LineStyle','-','LineWidth',0.2,'Color',colormap2(6,1:3)); hold on;
            end
        end
        % Namibia; Israel; Hubei; California; Iran;
        for cn=1:5
